...
public class MachineLearningMapperTest {

    @Test
    public void TEST_MAPPER() {
        List<MachineLearningModel> modelList = Testerke.createMachineLearningModel(getStortingen(), getLedigingen());
        assertThat(modelList).isEqualTo(getExpectedList());
    }

    //todo: implement expected list
    private List<MachineLearningModel> getExpectedList() {
        return null;
    }
